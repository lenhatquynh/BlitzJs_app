...
const Privacy: BlitzPage = () => {
  return (
    <>
      ...
      {/* <!-- page title --> */}
      <section className="section section--first section--bg custom-bg-privacy">
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-12">
              ...
              <p className="section__text">
                All the Lorem Ipsum generators on the <b>Internet</b> tend to repeat predefined
...
Privacy.getLayout = (page) => <Layout title="Details">{page}</Layout>
