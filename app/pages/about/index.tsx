...
const About: BlitzPage = () => {
  return (
    <>
      ...
      {/* <!-- page title --> */}
      <section className="section section--first section--bg custom-bg-about">
          ...
          <div className="row">
            ...
            <div className="col-12">
              <h2 className="section__title">
                <b>BLITZJS MOVIE</b> – Best Place for Movies
              </h2>

              <p className="section__text">
                It is a long <b>established</b> fact that a reader will be distracted by the
...
About.getLayout = (page) => <Layout title="Details">{page}</Layout>
