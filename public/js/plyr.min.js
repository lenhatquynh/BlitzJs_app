  ...
  (function (e, t) {
    ...
    function u(e, t, i) {
      ...
      if (e && "addEventListener" in e && !l.empty(t) && l.function(i)) {
        var r = t.split(" "),
          u = o
        c && (u = { passive: a, capture: o }),
          r.forEach(function (t) {
            s &&
              s.eventListeners &&
              n &&
              s.eventListeners.push({ element: e, type: t, callback: i, options: u }),
            ...
            return (function (e, t) {
              ...
              try {
                for (
                  ...
                  !(n = (o = r.next()).done) && (i.push(o.value), !t || i.length !== t);
                  n = !0
                );
              } catch (e) {
                ;(s = !0), (a = e)
    ...
    function C(e, t) {
      return l.element(t) && l.element(t.parentNode) && l.element(e)
    ...
    function M(e, t, i) {
      ...
      if (l.element(e)) {
        var n = "toggle"
        return (
          void 0 !== i && (n = i ? "add" : "remove"), e.classList[n](t), e.classList.contains(t)
        )
      }
      return !1
    }
                ...
                if (i) {
                  ...
                  ;(e.media.src = i.getAttribute("src")),
                    ("none" !== o || r) &&
                      ...
                      e.media.load()),
                    f.call(e, e.media, "qualitychange", !1, { quality: t }),
    ...
    function K() {
      ...
      return l.object(s)
        ? (Object.keys(s).forEach(function (t) {
            l.object(s[t])
              ? (Object.keys(e).includes(t) || Object.assign(e, y({}, t, {})), K(e[t], s[t]))
              : Object.assign(e, y({}, t, s[t]))
          }),
          K.apply(void 0, [e].concat(i)))
        : e
    }
    function Y(e) {
      ...
      if (l.string(e)) {
        ...
        if (!i || !n()) {
          ...
          ee(e)
            .then(function (e) {
              l.empty(e) ||
                (a && window.localStorage.setItem("cache-" + t, JSON.stringify({ content: e })),
                s(o, e))
            })
            .catch(function () {})
        }
    ...
    var oe = {
      ...
      findElements: function () {
        try {
          return (
            (this.elements.controls = _.call(this, this.config.selectors.controls.wrapper)),
      ...
      createButton: function (e, t) {
        ...
        return (
          a
            ? (i.appendChild(oe.createIcon.call(this, u, { class: "icon--pressed" })),
              i.appendChild(oe.createIcon.call(this, r, { class: "icon--not-pressed" })),
              i.appendChild(oe.createLabel.call(this, c, { class: "label--pressed" })),
              i.appendChild(oe.createLabel.call(this, o, { class: "label--not-pressed" })))
            : (i.appendChild(oe.createIcon.call(this, r)),
              i.appendChild(oe.createLabel.call(this, o))),
          K(n, P(this.config.selectors.buttons[s], n)),
          k(i, n),
          "play" === s
            ? (l.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []),
              this.elements.buttons[s].push(i))
            : (this.elements.buttons[s] = i),
          i
        )
      },
      createRange: function (e, t) {
        var i = w(
          "input",
          K(
            P(this.config.selectors.inputs[e]),
            {
              type: "range",
              min: 0,
              max: 100,
      ...
      createProgress: function (e, t) {
        var i = w(
          "progress",
          K(
            P(this.config.selectors.display[e]),
            { min: 0, max: 100, value: 0, role: "presentation", "aria-hidden": !0 },
            t
          )
        )
        if ("volume" !== e) {
                ...
                32 !== n.which &&
                  (40 === n.which || (s && 39 === n.which)
                    ? ((a = e.nextElementSibling),
                      l.element(a) || (a = e.parentNode.firstElementChild))
                    : ((a = e.previousElementSibling),
                      l.element(a) || (a = e.parentNode.lastElementChild)),
                  I.call(i, a, !0))
              }
            }
          },
      ...
      createMenuItem: function (e) {
        ...
        ;(p.innerHTML = a),
          ...
          oe.bindMenuItemShortcuts.call(this, h, s),
          n.appendChild(h)
      },
      formatTime: function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
      ...
      updateVolume: function () {
        this.supported.ui &&
          (l.element(this.elements.inputs.volume) &&
            oe.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
                ...
                ;(i = this.currentTime),
                  ...
                  (s =
                    0 === i || 0 === n || Number.isNaN(i) || Number.isNaN(n)
                      ? 0
                      : ((i / n) * 100).toFixed(2)),
                  "timeupdate" === e.type && oe.setRange.call(this, this.elements.inputs.seek, s)
                break
              case "playing":
              case "progress":
                !(function (e, i) {
      ...
      timeUpdate: function (e) {
        ...
        oe.updateTimeDisplay.call(
          ...
          (e && "timeupdate" === e.type && this.media.seeking) || oe.updateProgress.call(this, e)
      },
      durationUpdate: function () {
        if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
          if (this.duration >= Math.pow(2, 32))
            return S(this.elements.display.currentTime, !0), void S(this.elements.progress, !0)
          l.element(this.elements.inputs.seek) &&
          ...
          !e &&
            ...
            this.paused &&
            oe.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
            e && oe.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
            oe.updateSeekTooltip.call(this)
        }
      },
      ...
      updateSetting: function (e, t, i) {
        ...
        if ("captions" === e) s = this.currentTrack
          ...
          if (
            ((s = l.empty(i) ? this[e] : i),
            l.empty(s) && (s = this.config[e].default),
            !l.empty(this.options[e]) && !this.options[e].includes(s))
          )
        ...
        if ((l.element(a) || (a = n && n.querySelector('[role="menu"]')), l.element(a))) {
          ...
          ).innerHTML = oe.getLabel.call(this, e, s)
      ...
      setQualityMenu: function (e) {
        ...
        if (l.element(this.elements.settings.panels.quality)) {
          ...
          l.array(e) &&
            (this.options.quality = z(e).filter(function (e) {
        ...
        if (l.element(this.elements.settings.panels.captions)) {
          ...
          if ((oe.toggleMenuButton.call(this, "captions", n), E(t), oe.checkMenu.call(this), n)) {
            ...
            s.unshift({
              ...
              s.forEach(oe.createMenuItem.bind(this)),
              oe.updateSetting.call(this, "captions", t)
          }
        }
      },
      setSpeedMenu: function (e) {
        ...
        if (l.element(this.elements.settings.panels.speed)) {
          ...
          oe.toggleMenuButton.call(this, "speed", n),
            E(i),
            oe.checkMenu.call(this),
            n &&
      ...
      toggleMenu: function (e) {
        ...
        if (l.element(t) && l.element(i)) {
          ...
          i.setAttribute("aria-expanded", s),
            S(t, !s),
            M(this.elements.container, this.config.classNames.menu.open, s),
            s && l.keyboardEvent(e)
              ? oe.focusFirstMenuItem.call(this, null, !0)
              : s || n || I.call(this, i, l.keyboardEvent(e))
        }
      },
          ...
          if (F.transitions && !F.reducedMotion) {
            ...
            d.call(this, s, R, function t(i) {
              i.target === s &&
                ...
                ((s.style.width = ""), (s.style.height = ""), h.call(e, s, R, t))
            }),
      ...
      create: function (e) {
        ...
        if (
          (this.config.controls.includes("restart") &&
            i.appendChild(oe.createButton.call(this, "restart")),
          this.config.controls.includes("rewind") &&
            i.appendChild(oe.createButton.call(this, "rewind")),
          this.config.controls.includes("play") &&
            i.appendChild(oe.createButton.call(this, "play")),
          this.config.controls.includes("fast-forward") &&
            i.appendChild(oe.createButton.call(this, "fast-forward")),
          this.config.controls.includes("progress"))
        ) {
          var n = w("div", P(this.config.selectors.progress))
          if (
            (n.appendChild(oe.createRange.call(this, "seek", { id: "plyr-seek-" + e.id })),
            n.appendChild(oe.createProgress.call(this, "buffer")),
            this.config.tooltips.seek)
          ) {
        ...
        if (
          (this.config.controls.includes("current-time") &&
            i.appendChild(oe.createTime.call(this, "currentTime")),
          this.config.controls.includes("duration") &&
            i.appendChild(oe.createTime.call(this, "duration")),
          ...
          if (
            (this.config.controls.includes("mute") &&
              a.appendChild(oe.createButton.call(this, "mute")),
            this.config.controls.includes("volume"))
          ) {
            var o = { max: 1, step: 0.05, value: this.config.volume }
            a.appendChild(oe.createRange.call(this, "volume", K(o, { id: "plyr-volume-" + e.id }))),
        ...
        if (
          (this.config.controls.includes("captions") &&
            i.appendChild(oe.createButton.call(this, "captions")),
          this.config.controls.includes("settings") && !l.empty(this.config.settings))
        ) {
          var r = w("div", { class: "plyr__menu", hidden: "" })
          r.appendChild(
            oe.createButton.call(this, "settings", {
              "aria-haspopup": !0,
          ...
          var c = w("div", {
            ...
            u = w("div"),
            h = w("div", { id: "plyr-settings-" + e.id + "-home" }),
            p = w("div", { role: "menu" })
          h.appendChild(p),
            u.appendChild(h),
            (this.elements.settings.panels.home = h),
            this.config.settings.forEach(function (i) {
              var n = w(
                "button",
                K(P(t.config.selectors.buttons.settings), {
                  type: "button",
                  class:
                    t.config.classNames.control + " " + t.config.classNames.control + "--forward",
                  role: "menuitem",
                  "aria-haspopup": !0,
                  hidden: "",
                })
              )
              oe.bindMenuItemShortcuts.call(t, n, i),
                d(n, "click", function () {
                  oe.showMenuPanel.call(t, i, !1)
                })
              var s = w("span", null, X(i, t.config)),
                a = w("span", { class: t.config.classNames.menu.value })
              ;(a.innerHTML = e[i]), s.appendChild(a), n.appendChild(s), p.appendChild(n)
              var o = w("div", { id: "plyr-settings-" + e.id + "-" + i, hidden: "" }),
                r = w("button", {
                  type: "button",
                  class: t.config.classNames.control + " " + t.config.classNames.control + "--back",
                })
              r.appendChild(w("span", { "aria-hidden": !0 }, X(i, t.config))),
                r.appendChild(
                  w("span", { class: t.config.classNames.hidden }, X("menuBack", t.config))
                ),
                d(
                  o,
                  "keydown",
                  function (e) {
                    37 === e.which &&
                      (e.preventDefault(),
                      e.stopPropagation(),
                      oe.showMenuPanel.call(t, "home", !0))
                  },
                  !1
                ),
                d(r, "click", function () {
                ...
                o.appendChild(r),
                o.appendChild(w("div", { role: "menu" })),
                u.appendChild(o),
                (t.elements.settings.buttons[i] = n),
                (t.elements.settings.panels[i] = o)
            }),
            c.appendChild(u),
            r.appendChild(c),
            i.appendChild(r),
            (this.elements.settings.popup = c),
            (this.elements.settings.menu = r)
        }
        return (
          this.config.controls.includes("pip") &&
            F.pip &&
            i.appendChild(oe.createButton.call(this, "pip")),
          this.config.controls.includes("airplay") &&
            F.airplay &&
            i.appendChild(oe.createButton.call(this, "airplay")),
          this.config.controls.includes("fullscreen") &&
            i.appendChild(oe.createButton.call(this, "fullscreen")),
          this.config.controls.includes("play-large") &&
            this.elements.container.appendChild(oe.createButton.call(this, "play-large")),
          (this.elements.controls = i),
          this.isHTML5 && oe.setQualityMenu.call(this, U.getQualityOptions.call(this)),
          oe.setSpeedMenu.call(this),
          i
        )
      },
      inject: function () {
        ...
        s &&
          (l.string(this.config.controls)
            ? (i = a(i))
            : l.element(i) && (i.innerHTML = a(i.innerHTML)))
        var o = void 0
        if (
          (l.string(this.config.selectors.controls.container) &&
            (o = document.querySelector(this.config.selectors.controls.container)),
          l.element(o) || (o = this.elements.container),
          o[l.element(i) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", i),
          l.element(this.elements.controls) || oe.findElements.call(this),
    ...
    var ce = {
        setup: function () {
          if (this.supported.ui)
            if (!this.isVideo || this.isYouTube || (this.isHTML5 && !F.textTracks))
              l.array(this.config.controls) &&
                this.config.controls.includes("settings") &&
                this.config.settings.includes("captions") &&
                oe.setCaptionsMenu.call(this)
            else {
              var e, t
              if (
                (l.element(this.elements.captions) ||
                  ((this.elements.captions = w("div", P(this.config.selectors.captions))),
                  (e = this.elements.captions),
                  (t = this.elements.wrapper),
                  l.element(e) && l.element(t) && t.parentNode.insertBefore(e, t.nextSibling)),
                V.isIE && window.URL)
              ) {
              ...
              if (
                (l.boolean(a) || (a = this.config.captions.active),
                Object.assign(this.captions, { toggled: !1, active: a, language: s, languages: n }),
                this.isHTML5)
              ) {
        ...
        update: function () {
          ...
          this.isHTML5 &&
            ...
            ((r && this.language !== s) || !t.includes(o)) &&
              (ce.setLanguage.call(this, s), ce.toggle.call(this, n && r)),
            M(this.elements.container, this.config.classNames.captions.enabled, !l.empty(t)),
            (this.config.controls || []).includes("settings") &&
              this.config.settings.includes("captions") &&
              oe.setCaptionsMenu.call(this)
        },
          ...
          if (this.supported.ui) {
            ...
            if (s !== i) {
              ...
              this.elements.buttons.captions && (this.elements.buttons.captions.pressed = s),
                M(this.elements.container, n, s),
                (this.captions.toggled = s),
                oe.updateSetting.call(this, "captions"),
                f.call(this, this.media, s ? "captionsenabled" : "captionsdisabled")
            }
          }
        },
        set: function (e) {
              ...
              if (e in i) {
                if (this.captions.currentTrack !== e) {
                  ...
                  ;(this.captions.currentTrackNode = n),
                    ...
                    f.call(this, this.media, "languagechange")
                }
        ...
        getLabel: function (e) {
          ...
          return (
            ...
            l.track(t)
              ? l.empty(t.label)
                ? l.empty(t.language)
                  ? X("enabled", this.config)
                  : e.language.toUpperCase()
                : t.label
              : X("disabled", this.config)
          )
        },
              ...
              if (l.nullOrUndefined(e) || Array.isArray(e)) {
                ...
                if (n !== this.elements.captions.innerHTML) {
                  ...
                  ;(s.innerHTML = n),
                    ...
                    f.call(this, this.media, "cuechange")
                }
      ...
      de = { html5: "html5", youtube: "youtube", vimeo: "vimeo" },
      he = { audio: "audio", video: "video" }
    var pe = function () {},
      fe = (function () {
        function e() {
    ...
    function me() {
      if (this.enabled) {
        ...
        l.element(e) && (e.pressed = this.active),
          f.call(this.player, this.target, this.active ? "enterfullscreen" : "exitfullscreen", !0),
          V.isIos ||
            function () {
              var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]
    ...
    function ge() {
      ...
      e
        ...
        M(this.target, this.player.config.classNames.fullscreen.fallback, e),
        me.call(this)
    }
    var ye = (function () {
      function e(t) {
        ...
        m(this, e),
          ...
          d.call(this.player, this.player.elements.container, "dblclick", function (e) {
            ;(l.element(i.player.elements.controls) &&
              ...
              get: function () {
                return (
                  ...
                  (e.native
                    ...
                    : N(this.target, this.player.config.classNames.fullscreen.fallback))
                )
              },
            },
            {
    ...
    var be = {
        addStyleHook: function () {
          M(this.elements.container, this.config.selectors.container.replace(".", ""), !0),
            M(this.elements.container, this.config.classNames.uiSupported, this.supported.ui)
        },
        ...
        build: function () {
          ...
          if ((this.listeners.media(), !this.supported.ui))
            return (
              ...
              void be.toggleNativeControls.call(this, !0)
            )
          l.element(this.elements.controls) || (oe.inject.call(this), this.listeners.controls()),
            be.toggleNativeControls.call(this),
            ...
            oe.timeUpdate.call(this),
            be.checkPlaying.call(this),
            M(
              this.elements.container,
              this.config.classNames.pip.supported,
              F.pip && this.isHTML5 && this.isVideo
            ),
            M(
              this.elements.container,
              this.config.classNames.airplay.supported,
              F.airplay && this.isHTML5
            ),
            M(this.elements.container, this.config.classNames.isIos, V.isIos),
            M(this.elements.container, this.config.classNames.isTouch, this.touch),
            (this.ready = !0),
            setTimeout(function () {
              f.call(e, e.media, "ready")
            }, 0),
            be.setTitle.call(this),
            this.poster && be.setPoster.call(this, this.poster, !1).catch(function () {}),
        ...
        checkPlaying: function (e) {
          var t = this
          M(this.elements.container, this.config.classNames.playing, this.playing),
            M(this.elements.container, this.config.classNames.paused, this.paused),
            M(this.elements.container, this.config.classNames.stopped, this.stopped),
        ...
        checkLoading: function (e) {
          ...
          ;(this.loading = ["stalled", "waiting"].includes(e.type)),
            ...
            (this.timers.loading = setTimeout(
              function () {
                M(t.elements.container, t.config.classNames.loading, t.loading),
                  be.toggleControls.call(t)
              },
              this.loading ? 250 : 0
            ))
        },
        toggleControls: function (e) {
          ...
          t &&
            ...
            this.toggleControls(Boolean(e || this.loading || this.paused || t.pressed || t.hover))
        },
      },
      ke = (function () {
        function e(t) {
              ...
              value: function (e) {
                ...
                if (!(e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) && l.number(n)) {
                  if (s) {
                    ...
                    switch (
                      ([
                        32, 37, 38, 39, 40, 48, 49, 50, 51, 52, 53, 54, 56, 57, 67, 70, 73, 75, 76,
                        77, 79,
                    ...
                    (n = t.config.classNames.tabFocus),
                      ...
                      (this.focusTimer = setTimeout(function () {
                        ...
                        i.container.contains(e) &&
                          M(document.activeElement, t.config.classNames.tabFocus, !0)
                      }, 10))
                }
              },
            },
            {
              ...
              value: function () {
                ...
                t.config.keyboard.global &&
                  u.call(t, window, "keydown keyup", this.handleKey, e, !1),
                  u.call(t, document.body, "click", this.toggleMenu, e),
                  p.call(t, document.body, "touchstart", this.firstTouch),
                  u.call(t, document.body, "keydown focus blur", this.setTabFocus, e, !1, !0)
              },
            },
            {
              key: "container",
              value: function () {
                ...
                !e.config.keyboard.global &&
                  ...
                  d.call(e, t.container, "keydown keyup", this.handleKey, !1),
                  d.call(
                    e,
                    t.container,
                    ...
                    function (i) {
                      ...
                      var s = 0
                      ;["touchstart", "touchmove", "mousemove"].includes(i.type) &&
                        (be.toggleControls.call(e, !0), (s = e.touch ? 3e3 : 2e3)),
            ...
            },
            {
              ...
              value: function () {
                var e = this.player,
                  t = e.elements
                if (
                  (d.call(e, e.media, "timeupdate seeking seeked", function (t) {
                  ...
                  d.call(e, t.container, "click touchstart", function (n) {
                    ;([t.container, i].includes(n.target) || i.contains(n.target)) &&
                      ((e.config.hideControls &&
                        e.touch &&
                        N(t.container, e.config.classNames.hideControls)) ||
                ...
                e.supported.ui &&
                  ...
                  d.call(e, e.media, "volumechange", function () {
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  this.bind(
                    ...
                    function (e) {
                      ...
                      ;[13, 32].includes(i) &&
                        (13 !== i
                          ? (e.preventDefault(), e.stopPropagation(), oe.toggleMenu.call(t, e))
                          : oe.focusFirstMenuItem.call(t, null, !0))
                    },
                    null,
                    !1
                  ),
                    ...
                    function (e) {
                      ...
                      if (!l.keyboardEvent(e) || 39 === n || 37 === n) {
                        ...
                        s && a
                          ...
                          : !a && t.playing && (i.setAttribute("play-on-seeked", ""), t.pause())
                      }
                    }
                  ),
                  V.isIos)
                ...
                this.bind(
                  ...
                  V.isWebkit &&
                    Array.from(x.call(t, 'input[type="range"]')).forEach(function (i) {
                      e.bind(i, "input", function (e) {
                        return oe.updateRangeFill.call(t, e.target)
                      })
                    }),
                  t.config.toggleInvert &&
                    !l.element(i.display.duration) &&
                    this.bind(i.display.currentTime, "click", function () {
                      0 !== t.currentTime &&
                        ((t.config.invertTime = !t.config.invertTime), oe.timeUpdate.call(t))
                    }),
                  this.bind(
                    i.inputs.volume,
                    n,
                  ...
                  this.bind(i.controls, "focusin focusout", function (i) {
                    var n = t.config,
                      ...
                      o = "focusin" === i.type
                    if (
                      (M(s.controls, n.classNames.noTransition, o), be.toggleControls.call(t, o), o)
                    ) {
                      setTimeout(function () {
        ...
        ((function (e, t) {
          ...
          ;(i = function () {
            ...
            function o(t, i, n, s) {
              ...
              ;(s = s || 0),
                /(^css!|\.css$)/.test(t)
                  ? ((a = !0), ((r = l.createElement("link")).rel = "stylesheet"), (r.href = h))
    ...
    function Ee(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e &&
          ((this.media.paused = !e), f.call(this, this.media, e ? "play" : "pause"))
    }
    var Ce = {
      setup: function () {
        var e = this
        M(this.elements.wrapper, this.config.classNames.embed, !0),
          Ce.setAspectRatio.call(this),
          l.object(window.Vimeo)
            ? Ce.ready.call(this)
            : Ae(this.config.urls.vimeo.sdk)
                .then(function () {
                  Ce.ready.call(e)
                })
                .catch(function (t) {
      ...
      ready: function () {
        ...
        c.appendChild(o),
          (t.media = C(c, t.media)),
          ee(Y(t.config.urls.vimeo.api, a), "json").then(function (e) {
            if (!l.empty(e)) {
              var i = new URL(e[0].thumbnail_large)
              ;(i.pathname = i.pathname.split("_")[0] + ".jpg"),
                be.setPoster.call(t, i.href).catch(function () {})
            }
          }),
          (t.embed = new window.Vimeo.Player(o, { autopause: t.config.autopause, muted: t.muted })),
          (t.media.paused = !0),
        ...
        t.embed
          ...
          t.embed.on("loaded", function () {
            ...
            l.element(t.embed.element) && t.supported.ui) &&
          ...
          t.embed.on("progress", function (e) {
            ;(t.media.buffered = e.percent),
              f.call(t, t.media, "progress"),
              1 === parseInt(e.percent, 10) && f.call(t, t.media, "canplaythrough"),
              t.embed.getDuration().then(function (e) {
                e !== t.media.duration &&
                  ((t.media.duration = e), f.call(t, t.media, "durationchange"))
              })
    ...
    var Se,
      Me = {
        setup: function () {
          var e = this
          M(this.elements.wrapper, this.config.classNames.embed, !0),
            Me.setAspectRatio.call(this),
            l.object(window.YT) && l.function(window.YT.Player)
              ? Me.ready.call(this)
              : (Ae(this.config.urls.youtube.sdk).catch(function (t) {
        ...
        getTitle: function (e) {
          ...
          l.string(n) &&
            !l.empty(n) &&
            ee(Y(this.config.urls.youtube.api, e, n))
              .then(function (e) {
          ...
          if (l.empty(t) || !t.startsWith("youtube-")) {
            ...
            var n,
              s =
                ...
                l.empty(n)
                  ? null
                  : n.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/)
                  ? RegExp.$2
                  : n),
              a = e.provider + "-" + Math.floor(1e4 * Math.random()),
              o = w("div", { id: a, poster: e.poster })
            e.media = C(o, e.media)
            var r = function (e) {
                ...
                events: {
                  ...
                  onReady: function (t) {
                    if (!l.function(e.media.play)) {
                      ...
                      Object.defineProperty(e.media, "muted", {
                        ...
                        f.call(e, e.media, "durationchange"),
                  ...
                  onStateChange: function (t) {
                    ...
                    switch (
                      ...
                      e.media.seeking &&
                        [1, 2].includes(t.data) &&
                        ((e.media.seeking = !1), f.call(e, e.media, "seeked")),
                      t.data)
                    ) {
                      case -1:
                        f.call(e, e.media, "timeupdate"),
                      ...
                      case 0:
                        Pe.call(e, !1),
                          e.media.loop
                            ...
                            : f.call(e, e.media, "ended")
                        break
                      case 1:
                        e.media.paused && !e.embed.hasPlayed
                          ? e.media.pause()
                          : (Pe.call(e, !0),
                            f.call(e, e.media, "playing"),
        ...
        setup: function () {
          this.media
            ? (M(
              ...
              this.isEmbed &&
                M(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0),
              this.isVideo &&
                ((this.elements.wrapper = w("div", { class: this.config.classNames.video })),
                b(this.media, this.elements.wrapper),
                (this.elements.poster = w("div", { class: this.config.classNames.poster })),
        ...
        return (
          g(e, [
              ...
              value: function () {
                ...
                this.enabled &&
                  (l.object(window.google) && l.object(window.google.ima)
                    ? this.ready()
                    : Ae(this.player.config.urls.googleIMA.sdk)
                        .then(function () {
                          e.ready()
                        })
                        .catch(function () {
            ...
            },
            {
              key: "setupIMA",
              value: function () {
                ;(this.elements.container = w("div", { class: this.player.config.classNames.ads })),
            ...
            },
            {
              ...
              value: function (e) {
                for (
                  var t = this, i = arguments.length, n = Array(i > 1 ? i - 1 : 0), s = 1;
                  s < i;
                  s++
                )
                  n[s - 1] = arguments[s]
            ...
            },
            {
              ...
              value: function (e, t) {
                return (
                  l.array(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this
                )
              },
            },
            {
              ...
              this.destroy.call(
                ...
                function () {
                  ;(t.options.quality = []),
                    A(t.media),
                    (t.media = null),
                    l.element(t.elements.container) && t.elements.container.removeAttribute("class")
                  var i = e.sources,
                    n = e.type,
                    s = v(i, 1)[0],
                    a = s.provider,
                  ...
                  Object.assign(t, {
                    ...
                    be.addStyleHook.call(t),
                    t.isHTML5 && xe.insertElements.call(t, "source", i),
                    (t.config.title = e.title),
                    Ne.setup.call(t),
                    t.isHTML5 &&
                      ("tracks" in e && xe.insertElements.call(t, "track", e.tracks),
                      t.media.load()),
                    (t.isHTML5 || (t.isEmbed && !t.supported.ui)) && be.build.call(t),
                    t.fullscreen.update()
                },
                !0
              ))
      ...
      _e = (function () {
        function e(t, i) {
          ...
          if (
            ...
            (this.touch = F.touch),
            (this.media = t),
            l.string(this.media) && (this.media = document.querySelectorAll(this.media)),
            ...
            (this.debug = new fe(this.config.debug)),
            this.debug.log("Config", this.config),
            this.debug.log("Support", F),
                ...
                switch (a) {
                  case "div":
                    if (((o = this.media.querySelector("iframe")), l.element(o))) {
                      if (
                        ((r = re(o.getAttribute("src"))),
                        (this.provider = (function (e) {
                          return /^(https?:\/\/)?(www\.)?(youtube\.com|youtu\.?be)\/.+$/.test(e)
                            ? de.youtube
                        ...
                        var c = ["1", "true"]
                        c.includes(r.searchParams.get("autoplay")) && (this.config.autoplay = !0),
                          c.includes(r.searchParams.get("loop")) && (this.config.loop.active = !0),
                          this.isYouTube
                            ? ((this.config.playsinline = c.includes(
                                r.searchParams.get("playsinline")
                              )),
                              (this.config.hl = r.searchParams.get("hl")))
                    ...
                    if (l.empty(this.provider) || !Object.keys(de).includes(this.provider))
                ...
                ;(this.supported = F.check(this.type, this.provider, this.config.playsinline)),
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      (this.isHTML5 || (this.isEmbed && !this.supported.ui)) && be.build.call(this),
                      this.listeners.container(),
                      this.listeners.global(),
                      (this.fullscreen = new ye(this)),
          ...
          g(
            ...
            [
                ...
                value: function (e) {
                  ...
                  if (this.ready) {
                      ...
                      ;(document.body.style.overflow = ""),
                        ...
                        i
                          ...
                          : (function () {
                            ...
                            C(t.elements.original, t.elements.container),
                            f.call(t, t.elements.original, "destroyed", !0),
                            l.function(e) && e.call(t.elements.original),
                            (t.ready = !1),
                            setTimeout(function () {
                    ...
                    this.stop(),
                      this.isHTML5
                        ? (clearTimeout(this.timers.loading),
                          be.toggleNativeControls.call(this, !0),
                          n())
                        : this.isYouTube
              ...
              },
              {
                ...
                set: function (e) {
                  ...
                  l.string(t) && (t = Number(t)),
                    ...
                    l.number(t) || (t = this.config.volume),
                    t > 1 && (t = 1),
                    t < 0 && (t = 0),
                    (this.config.volume = t),
                    (this.media.volume = t),
                    !l.empty(e) && this.muted && t > 0 && (this.muted = !1)
                },
                get: function () {
                ...
                set: function (e) {
                  ...
                  l.number(e) && (t = e),
                    ...
                    this.config.speed.options.includes(t)
                      ? ((this.config.speed.selected = t), (this.media.playbackRate = t))
                ...
                set: function (e) {
                  ...
                  if (i.length) {
                    ...
                    if (!i.includes(n)) {
                      ...
                      this.debug.warn(
                        "Unsupported quality option: " + n + ", using " + s + " instead"
                      ),
                        (n = s)
                    }
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? be.setPoster.call(this, e, !1).catch(function () {})
                ...
                value: function (t) {
                  ...
                  return (
                    l.string(t)
                      ...
                      : l.nodeList(t)
                      ? (n = Array.from(t))
                      : l.array(t) && (n = t.filter(l.element)),
                    l.empty(n)
                      ? null
                      : n.map(function (t) {
                          return new e(t, i)
